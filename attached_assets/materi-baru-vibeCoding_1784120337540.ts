// ═══════════════════════════════════════════════════════════════════
// MATERI BARU VIBE CODING — 14 step baru + 1 sesi baru
//
// PETA PENEMPATAN (semua di artifacts/aigypt/src/lib/vibeCoding.ts):
//
//   BLOK A (1 step)  → Sesi 2: sisipkan SETELAH step id "vc2-5c",
//                      SEBELUM step id "vc2-6" (Kamus Kantong)
//   BLOK B (2 step)  → Sesi 3: sisipkan SETELAH step id "vc3-1",
//                      SEBELUM step id "vc3-2" (Blueprint Lima Pertanyaan)
//   BLOK C (3 step)  → Sesi 4: sisipkan SETELAH step id "vc4-4",
//                      SEBELUM step id "vc4-5" (Praktik: Bangun Versi Pertamamu)
//   BLOK D (2 step)  → Sesi 5: sisipkan SETELAH step id "vc5-3",
//                      SEBELUM step id "vc5-4" (Kuis Penutup)
//   BLOK E (1 sesi)  → Sesi 6 baru: tambahkan SETELAH objek Sesi 5,
//                      sebelum penutup array `];`
//
// JANGAN mengubah step yang sudah ada. JANGAN mengubah id apapun.
// Format mengikuti persis interface MateriStep di materiContent.ts.
// ═══════════════════════════════════════════════════════════════════

// ─────────────────────────────────────────────────────────────────
// BLOK A — SESI 2, setelah "vc2-5c": Soal Duit
// ─────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────
// BLOK B — SESI 3, setelah "vc3-1": Bank Ide + Cara Milih
// ─────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────
// BLOK C — SESI 4, setelah "vc4-4": Studi Kasus Satu Benang Utuh
// ─────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────
// BLOK D — SESI 5, setelah "vc5-3": Persiapan Demo Day
// ─────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────
// BLOK E — SESI 6 BARU: Dari Karya Jadi Rezeki
// Tambahkan sebagai objek sesi baru setelah Sesi 5, sebelum `];`
// ─────────────────────────────────────────────────────────────────
