          ...
          <table className="w-full text-sm" style={{ fontFamily: "'Inter',sans-serif" }}>
            <thead>
              <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                {["Nama / Email", "Tipe", "Jumlah", "Status", "Kode Akses", "Tanggal", "Aksi"].map(h => (
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={7} className="text-center py-10 text-sm" style={{ color: "#52525B" }}>Tidak ada pesanan</td></tr>
              ) : orders.map(o => (
                <tr key={o.id} style={{ borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                  ...
                  <td className="px-4 py-3 font-mono text-xs" style={{ color: "#A1A1AA" }}>Rp {o.grossAmount.toLocaleString("id-ID")}</td>
