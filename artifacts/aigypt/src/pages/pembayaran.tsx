              ...
              <>
                ...
                >
                  {loading ? (
                    ...
                    <>Saya Sudah Bayar — Konfirmasi <IconArrow /></>
                  )}
                </button>
                <p className="text-center text-xs mt-3" style={{ color: "#3F3F46" }}>
                  Klik tombol ini hanya setelah transfer berhasil. Kode akses akan dikirimkan ke WhatsApp kamu setelah admin memverifikasi pembayaran.
                </p>
              </>
            )}
          </motion.div>
